...
import { Calendar, Clock, MapPin, Video, ExternalLink, Briefcase } from 'lucide-react';
...
const UpcomingInterviews: React.FC<UpcomingInterviewsProps> = ({ applications }) => {
  ...
  const grouped = interviews.reduce((acc, app) => {
  ...
  return (
    <div className="max-w-4xl mx-auto pb-10 animate-fade-in">
       <div className="mb-8">
         <h2 className="text-2xl font-bold text-slate-800 mb-2">Upcoming Interviews</h2>
         <p className="text-slate-500">Track your scheduled calls, technical screens, and onsites.</p>
       </div>
       ...
       {interviews.length === 0 ? (
         <div className="bg-white rounded-xl border border-dashed border-slate-300 p-12 text-center">
            ...
            <p className="text-slate-500">When you schedule an interview in the Applications tab, it will appear here.</p>
         </div>
       ) : (
